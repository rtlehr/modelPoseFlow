...
interface PoseDescriptionInputProps {
  ...
  poseLength?: number; // Duration of each pose in seconds
}

export default function PoseDescriptionInput({ onDescriptionProcessed, poseCount = 10, poseLength = 30 }: PoseDescriptionInputProps) {
